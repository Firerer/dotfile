...
HOME = os.getenv("HOME")
XPLR_CONFIG_PATH = HOME .. "/.config/xplr"
package.path = XPLR_CONFIG_PATH .. "/?.lua;" .. XPLR_CONFIG_PATH .. "/?/init.lua;" .. package.path .. ";"
...
g.enable_mouse = true -- mouse scrolling
...
g.enforce_bounded_index_navigation = false -- cycle selection
...
xplr.config.node_types.special = {
	...
	["Downloads"] = { meta = { icon = "" }, style = { fg = "Blue" } },
}
